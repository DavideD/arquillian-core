...
public class ContainerImpl implements Container
{
   ...
   public ContainerImpl(String name, ClassLoader classLoader, DeployableContainer<?> deployableContainer, ContainerDef containerConfiguration)
   {
   ...
   /* (non-Javadoc)
    * @see org.jboss.arquillian.container.impl.ContainerT#getClassLoader()
    */
   @Override
